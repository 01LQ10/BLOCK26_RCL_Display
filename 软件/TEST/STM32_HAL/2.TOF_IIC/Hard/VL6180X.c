...
uint8_t read8(uint16_t address)
{
	...
	HAL_I2C_Master_Transmit(VL6180X_i2c, _i2caddr, buffer, 2, 10);
	HAL_I2C_Master_Receive(VL6180X_i2c, _i2caddr, buffer, 1, 10);
	return buffer[0];
}
...
uint16_t read16(uint16_t address)
{
	...
	HAL_I2C_Master_Transmit(VL6180X_i2c, _i2caddr, buffer, 2, 10);
	HAL_I2C_Master_Receive(VL6180X_i2c, _i2caddr, buffer, 2, 10);
...
void write8(uint16_t address, uint8_t data)
{
	...
	buffer[1] = (uint8_t)(address & 0xFF);
	buffer[2] = data;
	HAL_I2C_Master_Transmit(VL6180X_i2c, _i2caddr, buffer, 3, 10);
}
...
void write16(uint16_t address, uint16_t data)
{
	...
	HAL_I2C_Master_Transmit(VL6180X_i2c, _i2caddr, buffer, 4, 10);
}
