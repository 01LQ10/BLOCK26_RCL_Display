...
void BUTN_init(void)
{
    ...
    button_attach(&btn1, SINGLE_CLICK, BTN1_SINGLE_Handler);
    button_attach(&btn1, DOUBLE_CLICK, BTN1_DOUBLE_Handler);
    button_attach(&btn1, LONG_PRESS_START, BTN1_LONG_PRESS_Handler);
    button_start(&btn1);
}
